...
/// <summary>
/// Embedded form of the destination's native Avalonia order-book surface. Its toolbar is omitted so
/// the owning authored strategy remains the sole source of instrument and pause state.
/// </summary>
public partial class EmbeddedOrderBookPanel : UserControl, IEmbeddedPausable, IDisposable
{
    private RenderTargetBitmap? _freezeBitmap;

    public EmbeddedOrderBookPanel() => InitializeComponent();
