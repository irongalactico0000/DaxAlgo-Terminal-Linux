...
/// <summary>
/// Test-only copy of the Windows reference kernel. It keeps generic engine and optimizer coverage
/// without shipping a concrete strategy implementation in the macOS product assemblies. Reads its parameters from the
