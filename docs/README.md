...
- [Vibe Quant four-lane workflow](vibe-quant-four-lane-workflow.md) — how four real AI requests,
  durable strategy refinements, candidate states, TradeIR validation, Stop, and the separate
  exact-hash synthetic-test gate work.
