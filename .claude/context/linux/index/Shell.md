...
| `src/linux/Shell/TradingTerminal.App.Avalonia/Composition/ServiceConfiguration.cs` | 295 | linux | TradingTerminal.App.Avalonia | product | Y | Composition root for the Avalonia shell. Mirrors the Windows Professional Generic Host |
...
| `src/linux/Shell/TradingTerminal.App.Avalonia/Settings/StrategyAuthoringWindow.axaml` | 722 | linux | TradingTerminal.App.Avalonia | product | N | UI |
